...
export default function UsersTable() {
  ...
  const handleSearchChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Set a new timeout to update the keyword after 300ms
    timeoutIdRef.current = setTimeout(() => {
      setKeyword(value); // Update the keyword state after the delay
    }, 1000); // Delay of 300ms
  };
    ...
    <Card>
      <CardContent className="flex justify-between flex-col gap-4 items-start sm:flex-row sm:items-center">
        <div className="flex items-center gap-2">
          ...
          >
            <MenuItem value={10} selected={pageSize === 10}>10</MenuItem>
            <MenuItem value={25} selected={pageSize === 25}>25</MenuItem>
            <MenuItem value={50} selected={pageSize === 50}>50</MenuItem>
          </CustomTextField> */}
