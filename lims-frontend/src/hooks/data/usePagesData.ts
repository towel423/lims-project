...
import { useGetPages } from "../forms/admin/useGetPages";
import { usePagesQuery } from "../query/admin/usePagesQuery";
...
export const usePagesTable = () => {
  ...
  const { data, refetch, isLoading } = usePagesQuery({
    currentPage,
    pageSize,
    keyword,
  });
