...
const addTypeDocument = async (data: TypeDocumentsField): Promise<{ status: number; message: string } | undefined> => {
...
const AddMasterDocumentTypePage = () => {
  // States
  ...
  const tabContentLists: Record<TabKeys, ReactElement> = {
    "general-info": <GeneralInfoTab formTitle="Add Document Type" handleChangeTab={handleChange} dataMasterDocumentCategory={selectListDocumentCategory} changeFirstSave={changeFirstSave} isFirstSave={isFirstSave} />,
    "access-role": <AccessRoleTab formTitle="Add Document Type" handleChangeTab={handleChange} addTypeDocument={addTypeDocument} dataMasterRoleAction={dataMasterRoleAction} />,
  };
...
export default AddMasterDocumentTypePage;
