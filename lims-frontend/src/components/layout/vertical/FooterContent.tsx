...
const FooterContent = () => {
  ...
  return (
    ...
    >
      <p>
        <span className='text-textSecondary'>{`© ${new Date().getFullYear()} - All Right Reserved `}</span>
        {/* <span>{`❤️`}</span> */}
        <span className='text-textSecondary'>{` by `}</span>
        <Link href='https://lichemindo.com/' target='_blank' className='text-primary uppercase'>
          Lichem Center Indonesia
        </Link>
      </p>
      {!isBreakpointReached && (
